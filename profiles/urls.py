...
from .views import AdminManageUserPhotosView, AdminUserManagementView, AdminVerifyUserView, CloudinarySignatureView, CompleteOnboardingView, ManagePhotosView, PendingVerificationListView, UserList, UserDetail, UserLoginView, UserLogoutView, CurrentUserView, ViewContactDetailsAPI, VisitorHistoryList
...
urlpatterns = [
    ...
    path('admin/manage-users/<int:user_id>/photos/<str:action>/', AdminManageUserPhotosView.as_view()),
]